...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Bomba", 400, 300, 
                                         Color.white);
        }
    ...
    public void drawRGB(Object objekt, int r, int g, int b, Shape tvar) {
        this.objekty.remove(objekt);   // just in case it was already there
        this.objekty.add(objekt);      // add at the end
        this.tvary.put(objekt, new PopisTvaruRGB(tvar, r, g, b));
        this.redrawRGB();
    }
    ...
    public void drawRGB(Object objekt, BufferedImage image, AffineTransform transform) {
        this.objekty.remove(objekt);   // just in case it was already there
        this.objekty.add(objekt);      // add at the end
        this.tvary.put(objekt, new PopisObrazku(image, transform));
        this.redrawRGB();
    ...
    public void setForegroundColor(String farba) {
        if (farba.equals("red")) {
            ...
            //this.graphic.setColor(new Color(255, 255, 255));
            this.graphic.setColor(Color.white);
        }
    }

    public void setForegroundColorRGB(int r, int g, int b) {
    ...
    private class PopisTvaruRGB implements IDraw {
        private Shape tvar;
        private String farba;
        //private int r, g, b;
        private int r;
        private int g;
        private int b;
        public PopisTvaruRGB(Shape tvar, int r, int g, int b) {
            this.tvar = tvar;
            this.r = r;
            this.g = g;
            this.b = b;
        ...
        public void draw(Graphics2D graphic) {
            Platno.this.setForegroundColorRGB(this.r, this.g, this.b);
            graphic.fill(this.tvar);
    ...
    private class PopisObrazku implements IDraw {
        ...
        public void drawRGB(Graphics2D graphics) {
            graphic.drawImage(this.obrazok, this.transformacia, null); 
        }
    }
}
